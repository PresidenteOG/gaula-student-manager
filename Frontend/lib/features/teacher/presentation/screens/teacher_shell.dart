...
class _TeacherShellState extends ConsumerState<TeacherShell> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: isMobile ? Drawer(child: _TeacherSidebarContent(isMobile: true)) : null,
      body: Stack(
        children: [
          // Main Content
          AnimatedPadding(
          ...
          if (!isMobile)
            Positioned(
              ...
              child: AnimatedContainer(
                ...
                child: _TeacherSidebarContent(isExpanded: _isExpanded),
              ),
            ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  isMobile ? l10n.shellTeacherTituloMovil : l10n.shellTeacherTitulo,
                  style: TextStyle(
                    color: textColor,
...
class _TeacherSidebarContent extends ConsumerWidget {
  final bool isMobile;
  final bool isExpanded;
  const _TeacherSidebarContent({this.isMobile = false, this.isExpanded = true});
        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _SidebarItem(icon: Icons.home_outlined, label: l10n.navInicio, isActive: rutaActual == AppRoutes.teacherHome, isExpanded: isExpanded, onTap: () => context.go(AppRoutes.teacherHome)),
                _SidebarItem(icon: Icons.assignment_turned_in, label: l10n.navPasarLista, isActive: rutaActual == AppRoutes.teacherAsistenciaSchedule, isExpanded: isExpanded, onTap: () => context.go(AppRoutes.teacherAsistenciaSchedule)),
                _SidebarItem(icon: Icons.calendar_today, label: l10n.navMiHorario, isActive: rutaActual == AppRoutes.teacherHorario, isExpanded: isExpanded, onTap: () => context.go(AppRoutes.teacherHorario)),

                const SizedBox(height: 4),
                _SidebarItem(icon: Icons.people_outline, label: l10n.navAlumnos, isActive: rutaActual == AppRoutes.teacherAlumnos, isExpanded: isExpanded, onTap: () => context.go(AppRoutes.teacherAlumnos)),
                _SidebarItem(icon: Icons.book_outlined, label: l10n.navCursos, isActive: rutaActual == AppRoutes.teacherCursos, isExpanded: isExpanded, onTap: () => context.go(AppRoutes.teacherCursos)),
                _SidebarItem(icon: Icons.error_outline, label: l10n.navIncidencias, isActive: rutaActual == AppRoutes.teacherIncidencias, isExpanded: isExpanded, onTap: () => context.go(AppRoutes.teacherIncidencias)),

                const SizedBox(height: 4),
                _SidebarItem(icon: Icons.gavel_outlined, label: l10n.navNormasCentro, isActive: rutaActual == AppRoutes.teacherNormas, isExpanded: isExpanded, onTap: () => context.go(AppRoutes.teacherNormas)),
                _SidebarItem(icon: Icons.history, label: l10n.navHistorialClases, isActive: rutaActual == AppRoutes.teacherHistorial, isExpanded: isExpanded, onTap: () => context.go(AppRoutes.teacherHistorial)),

                const SizedBox(height: 4),
                _SidebarItem(icon: Icons.person_outline, label: l10n.navMiPerfil, isActive: rutaActual == AppRoutes.teacherProfile, isExpanded: isExpanded, onTap: () => context.go(AppRoutes.teacherProfile)),
                _SidebarItem(icon: Icons.settings_outlined, label: l10n.navAjustes, isActive: rutaActual == AppRoutes.teacherSettings, isExpanded: isExpanded, onTap: () => context.go(AppRoutes.teacherSettings)),
              ],
            ),
          ),
